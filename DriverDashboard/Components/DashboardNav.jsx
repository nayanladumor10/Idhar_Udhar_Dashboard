...
export default function DashboardNav() {
  ...
  return (
        <div className='w-full h-[8%] p-1 bg-gray-200/10 flex justify-between items-center px-2 py-2 rounded-none relative'>
       ...
       <Link to='support'>
        ...
        <Link to='profile'>
          <div className="profile h-11 rounded-md flex items-center hover:bg-gray-500/30 transition-all duration-200 p-1">
            <div className="ProfileName w-17 dark:text-white hidden sm:flex flex-col items-start p-1">
              <span className='text-sm font-medium'>{user.name}</span>
              <span className='text-xs text-gray-400'>4.8 <i className="fas fa-star"></i></span>
            </div>
            <div className="ProfileIcon sm:h-9 h-8 w-8 sm:rounded-lg rounded-full  bg-gray-400/60 text-white flex items-center justify-center">
